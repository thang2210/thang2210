...
// giai bai tap ve xau
// nhap 1 xau ki tu chuyen cac ki tu thanh in thuong 
/*#include<iostream>
#include<string.h>
using namespace std;
int main(){
...
// bai 3 : DEM SO LUONG xuat hien cac ki tu 
/*#include<iostream>
#include<string.h>
using namespace std;
int main(){
    // c1 : cac h tham khao tren mang 
    char s[100];
    gets(s);
    int count1 =0; // dem so tu trong cau
    int count2 =0; // kem ti tu trong cau
    for (int i =0 ;i < strlen(s);i++){
        if (isalpha(s[i])) count1++;
        else if(isdigit(s[i]))count2++;
    }
    cout << "so CHU CAI : " << count1 << endl;
    cout << "SO  : " << count2 << endl;
    cout << "so ki tu : " << strlen(s) - count1 - count2;
    return 0;
}  */
...
int main(){
    char s[100];
    gets(s);
    int count =1; // dem cac tu trong chuoi 
    for (int i =0 ;i < strlen(s) ;i++){
        if (isalpha(s[i])){
            count++;
        }
    ...
    cout <<"so tu trne se la : " << count1; << endl;
    cout << "so : " << count2 << endl;
    cout << "ki tu : " << strlen(s) - count - count2;
    return 0;
