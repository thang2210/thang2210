...
// Bài 22.Chữ số cuối cùng lớn nhấ
/*#include <iostream>
#include <math.h>
using namespace std;
int snt(int n)
...
#include <math.h>
using namespace std;
int pt1(int x, int y, int z, int n)
{
...
int main()
{
    ...
    cout << "boi se ;a : " << a << endl;
    cout << "uoc se la ; " << tich / a;
} */
